...
It uses [GNU Classpath](https://www.gnu.org/software/classpath/home.html), [Boost](https://www.boost.org/) v1.78.0 and [wallaroo](https://wallaroolib.sourceforge.net/index.html) v0.7.0.
